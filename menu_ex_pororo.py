...
def ExtractMenu(text, menu_kor):
    ...
    return string, temp, marker, marker_del

if __name__=="__main__":
    menu=["빅맥세트","맥플러리","슈니언 버거","치킨너겟", "후렌치후라이","콜라"]
    text="빈맥세트 하나 콜라 두개 후렌치 후라이 하나, 그리고 맥플라리 추가"
    res=ExtractMenu(text,menu)
    print(res)